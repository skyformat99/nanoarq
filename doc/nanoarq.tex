...
\usetikzlibrary{arrows,positioning,automata,calc,backgrounds}
...
\begin{bytefield}[bitwidth=1.1em,bitheight=2em]{32}
	\bitheader{0-31} \\
    \bitbox{8}{Version} & \bitbox{5}{Reserved} & \bitbox{1}{\tiny R\\S\\T} & \bitbox{1}{\tiny A\\C\\K} & \bitbox{1}{\tiny F\\I\\N} & \bitbox{8}{Payload Size} & \bitbox{8}{Window Size} \\
    \bitbox{12}{Sequence Number} & \bitbox{8}{Segment Size} & \bitbox{12}{Segment ID} \\
    \bitbox{12}{ACK Number} & \bitbox{8}{Reserved} & \bitbox{12}{ACK Segment ID} \\
...
All frames, including header and footer contents, are encoded using \todo{Explain and cite COBS}COBS.
