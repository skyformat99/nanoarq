...
\begin{example} Message is one frame, successfully received
    ...
    \end{arqladder}
\end{example}
\begin{example} Message is three frames, successfully received
    \begin{arqladder}
        \mess[1]{t}{SEQ 0 Frame 0}{r}
        \mess[1]{t}{SEQ 0 Frame 1}{r}
        \mess[1]{t}{SEQ 0 Frame 2}{r}
        \mess[1]{r}{ACK 1 Mask 111}{t}
    \end{arqladder}
\end{example}
\begin{example} Message is one frame, failed, NAK'd, and retransmitted
    \begin{arqladder}
    \end{arqladder}
\end{example}
