...
\newenvironment{field_explanations*}
...
\begin{bytefield}[bitwidth=1.1em,bitheight=2em]{32}
	...
	\begin{rightwordgroup}{Header}
        ...
        \bitbox{8}{Size}
        \bitbox{8}{Window} \\
        \bitbox{20}{sequence number} &
        \bitbox{12}{sub-frame id}
	\end{rightwordgroup} \\
...
\end{bytefield}
where
\begin{field_explanations*}
    Version & \nanoarq{} protocol version number \\
    Type & Frame type (RST / ACK) \\
    Sequence Number & Sequence number of current payload
\end{field_explanations*}
